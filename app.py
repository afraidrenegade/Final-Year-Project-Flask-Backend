...
selected_columns = ['FOOD NAME', 'GI', 'FATCE', 'ENERGY', 'WATER', 'PROTCNT', 'FIBTG', 'CA', 'Type', 'CA', 'MG', 'P', 'K', 'NA', 'ZN', 'FE', 'CHOLESTEROL', 'VITA_RAE', 'VITA', 'RETOL', 'VITB12', 'VITC']
...
def predict_food():
    ...
    response_columns = ['FOOD NAME', 'GI', 'FATCE', 'ENERGY', 'WATER', 'PROTCNT', 'FIBTG', 'CA', 'Type', 'CA', 'MG', 'P', 'K', 'NA', 'ZN', 'FE', 'CHOLESTEROL', 'VITA_RAE', 'VITA', 'RETOL', 'VITB12', 'VITC']
